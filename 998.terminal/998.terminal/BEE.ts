...
import CanvasUnit from "./03.canvas.unit/canvas.unit";
...
import Canvas from "./03.canvas.unit/fce/canvas.interface";
import { CanvasModel } from "./03.canvas.unit/canvas.model";
...
export const list: Array<any> = [TerminalUnit,InputUnit,ChoiceUnit,CanvasUnit,CollectUnit,MenuUnit,BusUnit];
...
import * as reduceFromCanvas from "./03.canvas.unit/canvas.reduce";
