...
import CanvasUnit from "./05.canvas.unit/canvas.unit";
...
import Canvas from "./05.canvas.unit/fce/canvas.interface";
import { CanvasModel } from "./05.canvas.unit/canvas.model";
...
import * as reduceFromCanvas from "./05.canvas.unit/canvas.reduce";
